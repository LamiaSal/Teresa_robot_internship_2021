...
class RobotEnv(gym.Env):
    ...
    def object_in_place(self, x, y, w, h):
        ...
        -   False --> otherwise
        """
        #x, y = state_to_pos(self.state) not needed
        #for more precision :  in the case of facial filter make sure the window of the facial filter is at the top of the wanted window
